    ...
    public class ReviewerCalibration
    {
        ...
        public Results Run(IEnumerable<Review> reviews)
        {
            ...
            return (new Results(
              ...
              // Utility.KeyValueArraysToDictionary(reviewers, fresulty))) ;
        }
        ...
        public class Results
        {
            ...
            // public IDictionary<Reviewer, Bernoulli[]> Resulty { get; private set; }
            ...
            public Results(
              ...
              // IDictionary<Reviewer, Bernoulli[]> resulty)
            {
                Quality = quality;
